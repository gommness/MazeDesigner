...
#include "../../MazeDesigner/Canvas/canvas.h"
...
QT_MOC_LITERAL(1, 7, 12), // "destroySpace"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9), // "destroyed"
QT_MOC_LITERAL(4, 31, 6), // "setPen"
QT_MOC_LITERAL(5, 38, 3), // "pen"
QT_MOC_LITERAL(6, 42, 14), // "setTransformed"
QT_MOC_LITERAL(7, 57, 11) // "transformed"

    },
    "Canvas\0destroySpace\0\0destroyed\0setPen\0"
    "pen\0setTransformed\0transformed"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->destroySpace((*reinterpret_cast< const QPolygonF(*)>(_a[1]))); break;
        case 1: _t->setPen((*reinterpret_cast< const QPen(*)>(_a[1]))); break;
        case 2: _t->setTransformed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Canvas::*)(const QPolygonF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::destroySpace)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::destroySpace(const QPolygonF & _t1)
{
