...
\begin{figure}{FIG:EXP:DESIGNTOGRAPH}{En esta figura se muestra como sería la conversión de un diseño a un grafo, si las condiciones en ambas puertas fueran la vacía en una dirección y tener una llave en la otra.}
	\subfigure[SBFIG:EXP:DESIGNTOGRAPHDESIGN]{Este sería un posible diseño construido en la aplicación.}{\image{4cm}{}{capturas/captura-diseno}} \quad
	\subfigure[SBFIG:EXP:DESIGNTOGRAPHGRAPH]{Esta sería la abstracción lógica implícita en el diseño.}{\image{4cm}{}{capturas/captura-grafo-disenno-1}}
\end{figure}
...
\begin{itemize}
	...
	\item Se define un \textbf{grafo del diseño} como el \dfn{grafo-dirigido} resultante de la abstracción de un diseño a grafo.
...
\begin{figure}{FIG:EXP:FUSION}{En esta figura se ilustra la operación de unión de nodos. Las sub-figuras \ref{SBFIG:EXP:FUSION11} y \ref{SBFIG:EXP:FUSION12} muestran un ejemplo básico mientras que las sub-figuras \ref{SBFIG:EXP:FUSION21} y \ref{SBFIG:EXP:FUSION22} muestran un ejemplo más completo}
	...
	\subfigure[SBFIG:EXP:FUSION12]{el caso \ref{SBFIG:EXP:FUSION11} se reduce a este grafo tras la operación de unión.}{\image{6cm}{}{capturas/fusion-ejemplo-1-2}} \quad
	\subfigure[SBFIG:EXP:FUSION21]{Un caso más complejo de nodos fuertemente conexos.}{\image{6cm}{}{capturas/fusion-ejemplo-2-1}} \quad
	\subfigure[SBFIG:EXP:FUSION22]{el caso \ref{SBFIG:EXP:FUSION21} se reduce a este grafo tras la operación de unión.}{\image{6cm}{}{capturas/fusion-ejemplo-2-2}} \quad
\end{figure}
...
Con estas formalizaciones, se puede realizar una búsqueda \dfn{A-estrella}\cite{russell2016artificial}\cite{nilsson1998artificial} para determinar si el diseño creado por el usuario es correcto o no.
