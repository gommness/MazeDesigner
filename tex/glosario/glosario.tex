...
Es importante no poner un punto al final de la definición dado que se añade automáticamente al final de las definiciones.
  ...
  \newdefinition{acronimoo}{acrónimo}{acrónimos}{Sigla cuya configuración permite su pronunciación como una palabra; por ejemplo, ovni: objeto volador no identificado; TIC, tecnologías de la información y la comunicación}
  \newdefinition{espacio-jugable}{espacio jugable}{espacios jugables}{regiones de un nivel por las que el jugador podrá mover a su avatar}
